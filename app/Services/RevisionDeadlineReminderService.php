...
class RevisionDeadlineReminderService
{
    ...
    private function processAuthor(ScheduledRevisionReminder $reminder): void
    {
        ...
        $body = "Dear {$submission->corresponding_author_name},\n\nThis is a reminder that the revision for your paper {$submission->paper_code}, \"{$submission->title}\", has not been received. The revision deadline is today, {$deadline}.\n\nPlease upload your revised editable manuscript through your Author Portal before the deadline.\n\nBest regards,\nEditorial Team\n{$submission->conference->name}";
