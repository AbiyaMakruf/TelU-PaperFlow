<x-layouts.app title="Edit conference - Paperflow" heading="Pengaturan conference">
    <div class="max-w-4xl"><a href="{{ route('conferences.show', $conference) }}" class="back-link">&larr; Kembali</a><h1 class="page-title mt-4">Pengaturan {{ $conference->name }}</h1><x-flash />
