<x-layouts.app title="Pengguna · Paperflow" heading="Pengguna">
    ...
    <form method="GET" class="mt-7 card flex gap-3 p-4">
        <input class="form-input" name="search" value="{{ request('search') }}" placeholder="Cari nama atau email">
