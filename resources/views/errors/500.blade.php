<x-layouts.public title="500 - Terjadi Kesalahan Server">
    <div class="mx-auto max-w-2xl py-6 sm:py-12 text-center">
        ...
        <p class="mt-3 text-sm sm:text-base text-slate-600 leading-relaxed max-w-lg mx-auto">
            Maaf, sistem mengalami kendala internal sementara saat memproses permintaan Anda. Tim kami telah mencatat kendala ini.
        </p>
        ...
        <div class="mt-8 pt-6 border-t border-navy/10 flex items-center justify-center gap-4 text-xs font-semibold text-muted">
            <button onclick="window.location.reload()" class="hover:text-navy transition inline-flex items-center gap-1 cursor-pointer">
