...
<table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:620px;background:#ffffff;border-radius:20px;overflow:hidden;box-shadow:0 12px 32px rgba(16,42,67,.10)">
    <tr><td style="background:#102a43;padding:30px 36px">
        <table role="presentation" width="100%"><tr><td><div style="font-size:24px;font-weight:900;color:#ffffff;letter-spacing:-.5px">Paper<span style="color:#f47c20">flow</span></div><div style="margin-top:7px;font-size:11px;font-weight:800;letter-spacing:2px;text-transform:uppercase;color:#f47c20">{{ $contextName }}</div></td><td align="right"><div style="width:44px;height:44px;line-height:44px;text-align:center;border-radius:13px;background:#f47c20;color:#fff;font-weight:900;font-size:20px">P</div></td></tr></table>
    </td></tr>
    <tr><td style="padding:38px 36px 24px">
        ...
        @if($actionUrl)
            <div style="padding:30px 0 12px"><a href="{{ $actionUrl }}" style="display:inline-block;background:#f47c20;color:#ffffff;text-decoration:none;font-size:14px;font-weight:800;padding:14px 24px;border-radius:12px">{{ $actionLabel ?: 'Buka Paperflow' }}</a></div>
