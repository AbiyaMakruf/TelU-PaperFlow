<x-layouts.app :title="$submission->paper_code" heading="Paper Details">
    <a class="back-link" href="{{ route('submissions.index') }}">&larr; Back to papers</a>
        ...
        <div class="min-w-0">
            ...
            <h1 class="page-title leading-tight break-words">{{ $submission->paper_id ?: $submission->paper_code }} <button type="button" data-copy="{{ $submission->paper_id ?: $submission->paper_code }}" onclick="window.copyPaperflowText(this.dataset.copy, 'Paper ID copied.')" class="inline-flex size-5 translate-y-[-0.08em] items-center justify-center rounded leading-none text-slate-400 hover:text-orange transition" title="Copy Paper ID" aria-label="Copy Paper ID"><svg class="block size-3.5" viewBox="0 0 512 512" fill="currentColor" aria-hidden="true"><path d="M384 336l0-208c0-35.3-28.7-64-64-64L128 64c-35.3 0-64 28.7-64 64l0 208c0 35.3 28.7 64 64 64l192 0c35.3 0 64-28.7 64-64zM128 112c-8.8 0-16 7.2-16 16l0 208c0 8.8 7.2 16 16 16l192 0c8.8 0 16-7.2 16-16l0-208c0-8.8-7.2-16-16-16L128 112zM384 16l-32 0 0 48 32 0c26.5 0 48 21.5 48 48l0 256c0 26.5-21.5 48-48 48l-48 0 0 48 48c53 0 96-43 96-96L480 112c0-53-43-96-96-96z"/></svg></button></h1>
            <div class="mt-1 flex items-start gap-1.5 min-w-0"><p class="page-subtitle leading-snug break-words min-w-0 flex-1">{{ $submission->title }}</p><button type="button" data-copy="{{ $submission->title }}" onclick="window.copyPaperflowText(this.dataset.copy, 'Paper title copied.')" class="mt-0.5 inline-flex size-5 shrink-0 items-center justify-center rounded leading-none text-slate-400 hover:text-orange transition" title="Copy Paper Title" aria-label="Copy Paper Title"><svg class="block size-3.5" viewBox="0 0 512 512" fill="currentColor" aria-hidden="true"><path d="M384 336l0-208c0-35.3-28.7-64-64-64L128 64c-35.3 0-64 28.7-64 64l0 208c0 35.3 28.7 64 64 64l192 0c35.3 0 64-28.7 64-64zM128 112c-8.8 0-16 7.2-16 16l0 208c0 8.8 7.2 16 16 16l192 0c8.8 0 16-7.2 16-16l0-208c0-8.8-7.2-16-16-16L128 112zM384 16l-32 0 0 48 32 0c26.5 0 48 21.5 48 48l0 256c0 26.5-21.5 48-48 48l-48 0 0 48 48c53 0 96-43 96-96L480 112c0-53-43-96-96-96z"/></svg></button></div>
        </div>
    ...
    <div class="mt-7 grid gap-6 xl:grid-cols-[1fr_340px] min-w-0 w-full max-w-full">
        <div class="space-y-6 min-w-0 w-full max-w-full">
            ...
            <details class="card overflow-hidden max-w-full min-w-0" x-data="{ deleteTarget: null, activeNotesModal: null }">
