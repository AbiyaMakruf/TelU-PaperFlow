@echo off
title Paperflow Ngrok Server (Mobile & HP Compatible)
cls
...
echo ========================================================
echo        PAPERFLOW NGROK LAUNCHER (UNTUK HP & LAPTOP LAIN)
echo ========================================================
echo.
echo  [1/2] Membesihkan cache hot-reload & kompilasi CSS/JS...
echo.
...
echo.
echo  [2/2] Menjalankan layanan Paperflow & Ngrok:
...
echo  Akses dari HP & laptop lain kini 100% memuat CSS tanpa popup!
